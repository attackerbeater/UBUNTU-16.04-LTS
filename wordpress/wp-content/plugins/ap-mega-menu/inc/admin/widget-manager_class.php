    ...
    class WPMM_Menu_Widget_Manager {
        ...
        public function wpmm_get_specific_widgets() {
            ...
            foreach ($wp_widget_factory->widgets as $wordpress_widget) {
                ...
                $enabled_widgets = array('wpmegamenu_contact_info','wpmegamenu_pro_linkimage',
        ...
        public function wpmm_get_available_widgets() {
            ...
            foreach ($wp_widget_factory->widgets as $wordpress_widget) {
                ...
                $disabled_widgets = array('wpmegamenu_widget', 'wpmegamenu_contact_info','wpmegamenu_pro_linkimage',
                    'wpmegamenu_pro_html_text');
