<div class="wpmm_mega_settings">
  <div class="settings_content">
      <div class="settings_title"><h4><?php _e('Menu Item Settings',APMM_TD);?></h4></div>
  	   <table class="widefat">
			<tr>
			<td class="wpmm_meta_table"><label for="disable_menu_text"><?php _e("Hide Menu Text", APMM_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
			          ...
			          <label for="disable_menu_text"></label>
                       ...
                       <p class="description"><?php _e("Note: Enable this option if you want to hide menu title and the height of this invisible menu title will be hidden as well.", APMM_TD); ?></p>
			  </td>
			</tr>	
			<tr>
			<td class="wpmm_meta_table"><label for="visible_hidden_text"><?php _e("Hide Menu Text With Visible Height", APMM_TD) ?></label></td>
			  <td> 
			       <div class="wpmm-switch">
                      ...
                      <p class="description"><?php _e("Note: Enable this option if you want to hide menu title but the respective height of this menu text need to be displayed.", APMM_TD); ?></p>
			  </td>
			</tr>
			<tr>
			<td class="wpmm_meta_table"><label for="active_menu_link"><?php _e("Active Menu Link", APMM_TD) ?></label></td>
				  <td> 
                      ...
                      <p class="description"><?php _e("Note: Enable this option if you want to active menu link. By default, menu will not be linked.", APMM_TD); ?></p>
			  </td>
			</tr>
			<tr>
		  ...
		  <tr>
			<td class="wpmm_meta_table"><label for="menu_icon"><?php _e("Show Menu Icon", APMM_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
                 ...
                 <p class="description"><?php _e("Note: Enable this option if you want to show menu icon choosed from Icon Settings.
                  Enabling this option is required to display menu icon. If disable, icon will not be shown on frontend for this menu item.", APMM_TD); ?></p>
			  </td>
			</tr>
			...
			<td class="wpmm_meta_table"><label for="active_single_menu"><?php _e("Active Single Menu", APMM_TD) ?></label></td>
			  ...
			  <p class="description"><?php _e('Enable this option if this menu item is custom single menu link type.
			  i.e Useful for all Custom Menu For Social Links such as facebook, twitter and so on.',APMM_TD);?></p>
			  </td>
			</tr>
			...
			<td>
			    ...
			    <p class="description" style="margin-top: 31px;"><?php _e('Right aligned items will appear in reverse order on the right hand side of the menu bar.Specially for search icon and oher custom links with social icons.',APMM_TD);?></p>
			</td>
			</tr>
