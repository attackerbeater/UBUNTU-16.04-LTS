...
<head>
	...
	<style type="text/css">
		...
		body{
		    background-image: url("<?= base_url('assets/images/src/merchant.jpg') ?>");
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item">
	      	...
	      	<span class="malle-logo-text  second-item">MERCHANTS</span>
	    ...
	    <ul class="navbar-nav my-2 my-lg-0">
			...
			<!--
				...
				<p  style="  margin-bottom: 0px;">Merchant</p>
	      		...
	      		<button class="btn-orange my-2 my-sm-0 " type="submit">Open Free Account</button>
			...
			<div class="col-md-7 mt-5" style="margin-top: 13rem!important;">
				<div class="row mt-4">
					<div class="col-md-12">
						...
						<form method="post" action="<?= base_url('Merchant/sendEmail') ?>" class="mt-4 inquiry-form" autocomplete="off">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<input type="text" name="merchant_name" id="merchant_name" class="form-control form-control-sm" placeholder="Merchant or Company Name" required>
											</div>
										</div>
									</div>
									<div class="row">
