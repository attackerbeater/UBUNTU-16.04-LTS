...
<head>
	...
	<style>
		.malle-body2 {
			background: url(../../assets/images/src/merchant.jpg) no-repeat;
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row latest-deals-container mt-5">
			<h3 style="    width: 100%;">Merchants</h3>
			<div id="filters">  
               <style>
               ...
               <ul class="filter">
                   	<?php foreach($merchanttype_count as $mtc): ?>
                  	    <li>
                  	    	<a data-filter=".<?=str_replace('&', 'and',str_replace(' ', '-', strtolower($mtc->type)))?>">
                  	    		<p><?=$mtc->type .'('.$mtc->total_count.')'?> |</p>
                  	    	</a>
                  	    </li> 
                  	<?php endforeach; ?>                	
               </ul> 
			...
			<div class="col-md-12 grid">
				<div class="row mt-5">					
					...
					<div class="col-md-2 mt-3 mr-4 merchantcontainer element-item <?=str_replace('&', 'and',str_replace(' ', '-', strtolower($mer->type)))?>" data-id="<?=$mer->merchant_id?>" data-lat="<?=$mer->lat?>" data-long="<?=$mer->long?>">
							  ...
							  <div class="card-body-mall">
							    ...
							    <div class="row">
							    	...
							    	<div class="col-md-12">
							    		...
							    		<h5 class="name"><?=$mer->merchant_name?></h5>
