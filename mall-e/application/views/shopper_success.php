			...
			<div class="col-md-6 mt-5" style="margin-top: 13rem!important;">
				<div class="row mt-4">
					<div class="col-md-12">
						...
						<form method="post" class="mt-4 inquiry-form" autocomplete="off">
							<h5>Registered Shopper</h5>
							<div class="row">
								<div class="col-md-12">
									
									<div class="form-group mt-m">
												<strong class="text-primary">Hi, <?=$this->session->userdata('name_login')?></strong>
												
											</div>
									
								</div>
								<p class="foot mt-2">You have successfully login.</p>
								<!--<div class="col-md-2 mt-2">
											<button type="button" class="btn btn-primary btn-sm col-md-12">Ok</button>
										</div>-->
							</div>
						</form>
