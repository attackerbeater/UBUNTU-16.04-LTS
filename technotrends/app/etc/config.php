...
return [
    'modules' => [
        'AcmeWidgets_Ajax' => 1,
        'AcmeWidgets_Customer' => 1,
        'AcmeWidgets_JsLayout' => 1,
        'AcmeWidgets_Knockout' => 1,
        'AcmeWidgets_PaymentMethod' => 0,
        'AcmeWidgets_Setup' => 1,
        'Magento_Store' => 1,
        'Magento_Directory' => 1,
        'Magento_Theme' => 1,
        'Magento_Backend' => 1,
        'Ewave_ServiceContract' => 1,
        'Magento_Variable' => 1,
        'KTPL_Knockoutjs' => 1,
        'Magento_Eav' => 1,
        ...
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Magestudy_CustomerEditTab' => 1,
        'Magestudy_Customjs' => 1,
        'Magestudy_Mixins' => 1,
        'Magestudy_PaymentMethod' => 1,
        'Temando_Shipping' => 0,
        'Vertex_Tax' => 0
    ]
];
