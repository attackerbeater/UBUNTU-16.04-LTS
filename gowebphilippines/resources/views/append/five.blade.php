<form method="post" action="" class="form-five-update" enctype="multipart/form-data">
  {{ csrf_field() }}
  <input type="hidden" name="status_update" value="1" />
  <input type="hidden" name="form" value="form-five-update" />
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3 hide">
            ...
            <input type="file" accept="application/pdf" name="upload_confirmation_supplier_doc" class="form-control-file" id="upload_confirmation_supplier_doc_5_update" aria-describedby="fileHelp">
            <small id="fileHelp" class="form-text text-muted">UPLOAD SIGNED ORDER CONFIRMATION</small>
          </div>
          <script type="text/javascript">
          document.getElementById("upload_confirmation_supplier_doc_5_update").disabled = true;
          </script>
          <div class="mb-3 hide">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-sm btn btn-success pull-right">Send</button>
  </div>
</form>
