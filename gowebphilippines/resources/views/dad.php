  ...
  <div class="table-responsive">
    <table id="orders" class="display table table-striped table-sm" cellspacing="0" width="100%">
      ...
      <tbody>
        ...
        <tr id="{{$list->id}}">
          <td><a style="color:#333; text-decoration: underline;" href='{{url("/admin/oread/{$list->client_id}/{$refnum}")}}'>{{$list->order_reference_number}}</a></td>
          <td><a style="color:#333; text-decoration: underline;" href='{{url("/admin/oread/{$list->client_id}/{$refnum}")}}'>{{$list->order_clients}}</a></td>
          <td>
          ...
          <td>
            <a class="btn btn-info btn-sm" href='{{url("/admin/oread/{$list->client_id}/{$refnum}")}}'>
  ...
  <div class="modal-dialog modal-lg">
                                ...
                                <div class="row append-treatment">
                                  <div class="col-md-12 mb-3 treatment-for-this-product">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control treatment-title" id="treatment-title" placeholder="Title">
                                    </div>
                                    <div class="mb-3">
                                      <label for="title">Treatment description</label>
                                      <textarea id="treatment-details" class="form-control treatment-details"></textarea>
                                    </div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label for="">File input</label>
                  <input type="file" accept="application/pdf" name="upload_recieved_quotation" class="form-control-file" id="upload_recieved_quotation">
                  <small id="fileHelp" class="form-text text-muted">Upload recieved quotation</small>
                </div>
              </div>
            </div>
    ...
    <div class="form-field-modal-default hide" id="form-field-modal-default-four">
      <form method="post" action="" id="4a" enctype="multipart/form-data">
        {{ csrf_field() }}
        <input type="hidden" name="is_upload" value="1" />
        <input type="hidden" name="column" value="upload_quote_acceptance_from_client" />
          ...
          <div class="container col-md-12">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label for="exampleInputFile">File input</label>
                  <input type="file" accept="application/pdf" name="upload_client_confirmation" class="form-control-file" id="exampleInputFile 3" aria-describedby="fileHelp">
                  <small id="fileHelp" class="form-text text-muted">Upload client confirmation</small>
                </div>
                <div class="mb-3">
    ...
    <div class="form-field-modal-default hide" id="form-field-modal-default-six">
      <form method="post" action="" id="6" enctype="multipart/form-data">
        ...
        <input type="hidden" name="path" value="supplier" />
        <input type="hidden" name="column" value="upload_confirmation_supplier_doc" />
    ...
    <div class="form-field-modal-default hide" id="form-field-modal-default-seven">
      <form method="post" action="" id="7" enctype="multipart/form-data">
        ...
        <input type="hidden" name="status" value="8.GENERATE CONFIRMATION TO CLIENT" />
        <input type="hidden" name="path" value="client" />
        <input type="hidden" name="column" value="goods_received_from_client" />
    ...
    <div class="form-field-modal-default hide" id="form-field-modal-default-eight">
      <form method="post" action="" id="8" enctype="multipart/form-data">
        ...
        <input type="hidden" name="path" value="supplier" />
        <input type="hidden" name="column" value="upload_send_confirmation_to_supplier" />
          ...
          <div class="container col-md-12">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3 hide">
                  <label for="upload_delivery_document">File input</label>
                  <input type="file" accept="application/pdf" name="upload_delivery_document" class="form-control-file" id="upload_delivery_document_nine_view" aria-describedby="fileHelp">
                  <small id="fileHelp" class="form-text text-muted">UPLOAD DELIVERY DOCUMENT</small>
                </div>
                <script type="text/javascript">
                document.getElementById("upload_delivery_document_nine_view").disabled = true;
                </script>
                <div class="mb-3 hide">
          ...
          <div class="container col-md-12">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label for="upload_delivery_document">File input</label>
                  <input type="file" accept="application/pdf" name="upload_delivery_document" class="form-control-file" id="upload_delivery_document_nine" aria-describedby="fileHelp">
                  <small id="fileHelp" class="form-text text-muted">UPLOAD DELIVERY DOCUMENT</small>
                </div>
          ...
          <div class="container col-md-12">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3 hide">
                  <label for="invoice_received">File input</label>
                  <input type="file" accept="application/pdf" name="invoice_received" class="form-control-file" id="invoice_received_twelve_view" aria-describedby="fileHelp">
                  <small id="fileHelp" class="form-text text-muted">UPLOAD SUPPLIER INVOICE</small>
                </div>
                <script type="text/javascript">
    ...
    <div class="form-field-modal-default hide" id="form-field-modal-default-thirteen">
      <form method="post" action="" id="13" enctype="multipart/form-data">
        {{ csrf_field() }}
        <input type="hidden" name="status" value="14.INVOICE PAID" />
        ...
        <div class="modal-body">
          <div class="container col-md-12">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="mb-3 hide">
                  <label for="upload_delivery_document hide">File input</label>
                  <input type="file" accept="application/pdf" name="upload_delivery_document" class="form-control-file" id="invoice_received_thirteen_view" aria-describedby="fileHelp">
                ...
                <div class="mb-3 hide">
                  <label for="upload_delivery_document">File input</label>
                  <input type="file" accept="application/pdf" name="upload_delivery_document" class="form-control-file" id="upload_delivery_document_thirteen_view" aria-describedby="fileHelp">
                  <small id="fileHelp" class="form-text text-muted">UPLOAD SUPPLIER INVOICE</small>
                </div>
                <script type="text/javascript">
                document.getElementById("upload_delivery_document_thirteen_view").disabled = true;
                </script>
