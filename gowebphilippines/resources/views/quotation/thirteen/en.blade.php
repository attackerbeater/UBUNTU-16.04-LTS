...
<form method="post" action="{{url('vendor/unisharp/laravel-ckeditor/process.php')}}">
  ...
  <textarea class="ckeditor en" name="editor" id="editor-en" frameborder="0px">
      ...
      <tbody>
        <tr>
          ...
          <td style="width:132px;">
            <p align="center"><strong><span ><span >CUSTOMER V.A.T.- NUMBER</span></span></strong></p>
          </td>
          <td style="width:113px;">
            <p style="margin-left:20.0pt;"><strong><span ><span >INVOICE NUMBER</span></span></strong></p>
          </td>
          <td style="width:141px;">
            <p style="text-align: center;"><strong><span ><span >CUSTOMER NUMBER&nbsp;</span></span></strong></p>
          </td>
          <td style="width:237px;">
            <p align="center"><strong><span ><span >PAYMENT CONDITIONS</span></span></strong></p>
          </td>
        </tr>
        <tr>
          <td style="width:96px;">
          ...
          <td style="width:237px;">
            <p style="text-align: center;">
              <span >
                <span >Our terms are NET 30 days from date </span>
              </span>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="width:87px;">
            <p style="text-align: center;"><strong><span ><span >QTY.</span></span></strong></p>
          </td>
          <td colspan="2" style="width:407px;">
            <p style="text-align: center;"><strong><span ><span >DESCRIPTION</span></span></strong></p>
          </td>
          <td style="width:113px;">
            <p style="text-align: center;"><strong><span ><span >COSTS PER PIECE</span></span></strong></p>
          </td>
          <td style="width:87px;">
            <p style="text-align: center;"><strong><span ><span >TOTALPRICE</span></span></strong></p>
          </td>
        </tr>
        <tr>
          <td style="width:87px;"></td>
          <td colspan="2" style="width:407px;">
            <p style="margin-left: 9pt;"><span ><span >Your order {{$orders['order_reference_number']}} dated {{date('d/m/Y')}} for {{$orders['order_subject']}}&nbsp;</span></span></p>
          </td>
          <td style="width:113px;"></td>
          <td style="width:87px;"></td>
        </tr>
        ...
        <tr>
          ...
          <?php $total_vat = ($percentage / 100) * $subtotal; ?><!-- 11/10/2018 -->
          <td style="width:113px;height:5px; ">
            
            <p style="text-align: right;"><span ><span >&nbsp; V.A.T. {{$percentage}}%&nbsp;</span></span>&euro;&nbsp; &nbsp;</p>
          </td>
          <td colspan="2" style="width:115px;height:5px; ">
            <!-- 11/10/2018 -->
            @if($total_vat > 0)
    ...
    <p><strong><span ><span >Please make payment of this invoice free of costs on our Bankaccount at the KBC-Bank IBAN BE69 4428 6426 5178</span></span></strong><br/>
      <span >Address :&nbsp; KBC-KREDIETBANK NV.</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span ><span >Kerkstraat, 57&nbsp;&nbsp;&nbsp;&nbsp; B-9200&nbsp; Dendermonde</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span ><span style="font-size:9.5pt;">Swift&nbsp; :&nbsp; KREDBEBB</span></span></p>
