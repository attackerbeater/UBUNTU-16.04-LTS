...
<!--     <script src="{{url('assets/lib/dataTables.cellEdit.js')}}"></script> -->
                  ...
                  if(order_treatment_details){
                    ...
                    */
                    ...
                    $(document).ready(function() {
                      ...
                      // $('#klanten').on( 'click', 'tbody td:first-child', function (e) {
                        // alert($(this).text());

                        // var html = $(this).text(); //$(this).html();
                        // var input = $('<input class="editableColumnsStyle" type="text" value="'+$(this).text()+'"/>');
                        // input.val(html);
                    ...
                    <script src="{{url('assets/library/dataTables.cellEdit.js')}}"></script>
                    <script src="{{url('assets/library/advanced.js')}}"></script>
