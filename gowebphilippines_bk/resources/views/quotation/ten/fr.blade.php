<div id="fr">
  <form method="post" action="{{url('vendor/unisharp/laravel-ckeditor/process.php')}}">
    ...
    <textarea class="ckeditor" name="editor" id="editor-fr">
      ...
      <p><span style="font-size:24px;"><strong>BON DE LIVRAISON</strong></span></p>
        ...
        <tbody>
          <tr>
            ...
            <td style="width:123px">
              <p style="text-align:center"><strong>NUMÉRO DE TVA</strong></p>
            </td>
            <td style="width:142px">
              <p style="text-align:center"><strong>NUMÉRO DOC.</strong></p>
            </td>
            <td style="width:142px">
              <p style="text-align:center"><strong>NUMÉRO CLIENT</strong></p>
            </td>
        ...
        <tbody>
          <tr>
            ...
            <td style="height:26px; width:91px">
              <p style="text-align:center"><strong>Nombre IN</strong></p>
            </td>
          ...
          <tr>
            ...
            <td style="height:125px; width:340px">
              <p style="margin-left:40px">Votre ordre Nr. {{ $orders['order_number_from_client'] }} &nbsp;à la date {{ date('d/m/Y') }}&nbsp;</p>
              <p style="margin-left:40px">Pour {{ $orders['order_subject'] }}</p>
              <?php
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      <p>Approvisionnement intracommunautaire</p>
      <p>Les parties conviennent explicitement que leurs relations contractuelles sont régies exclusivement par les présentes conditions générales de vente. Les marchandises sont expédiées aux risques et périls de l'acheteur. Le contrôle des marchandises, la qualité et la quantité, se produit à la livraison. Les réclamations ne seront pas acceptées si elles ne figuraient pas sur le bons de livraison ou sur la facture au moment de la livraison, et confirmées par écrit dans les trois jours. </p>
      <p>Pour la réception en bon état: </p>
    </div>
  </textarea> <!-- CKEditor  !-->
</form>
</div>
