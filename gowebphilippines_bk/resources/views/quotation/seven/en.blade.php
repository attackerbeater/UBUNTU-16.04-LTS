<div id="en">
  <form method="post" action="{{url('vendor/unisharp/laravel-ckeditor/process.php')}}">
    ...
    <p>Delivery: From factory, conditions in attachment.</p>
    <p>This order has been carefully determined by us and the information you provide. If you want to report inaccuracies immediately, so this order confirmation may need to be adjusted.</p>
    <p>Thank you for your order and confidence</p>
    <p>Total cost are exlusive transportation costs</p>
    <p>&nbsp;</p>
