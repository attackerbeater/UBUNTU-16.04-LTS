$(function() {
    ...
    $('body').on("click", ".add_treatment_button_with-no-price", function(e) {
          ...
          $(this).parent().parent().parent().find('.append-treatment').append(
             '<div class="col-md-12 mb-3">'+
                 ...
                 '<div class="mb-3" style="display:none;">'+
                      ...
                      '<input type="hidden" class="form-control" name="order_treatment_price[product_name]['+index+'][]" id="treatprice'+counter+'" value="0">'+
                 '</div>'+
             '</div>'
          );
        }
