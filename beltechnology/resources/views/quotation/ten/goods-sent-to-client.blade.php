    ...
    <div class="col-lg-12">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="profile" role="tabpanel">
          ...
          <!-- en -->
          @include('quotation.ten.en')
          <!-- fr -->
          @include('quotation.ten.fr')
          <!-- nl -->
          @include('quotation.ten.nl')
          <!-- de -->
          @include('quotation.ten.de')    
        </div>
          ...
          <div class="tab-pane" id="home" role="tabpanel">
            ...
            <form name=f1 id="post-generate-delivery-document" method="post" action="{{ url('/admin/sent-delivery-document-to-supplier') }}" role="form" enctype="multipart/form-data">
              {{ csrf_field() }}
