    ...
    <div class="col-lg-12">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="profile" role="tabpanel">
          ...
          <!-- en -->
          @include('quotation.three.en')
          <!-- fr -->
          @include('quotation.three.fr')
          <!-- nl -->
          @include('quotation.three.nl')
          <!-- de -->
          @include('quotation.three.de')     
        </div>
        <div class="tab-pane" id="home" role="tabpanel">
          ...
          <form name=f1 id="post-generate-quotation-request-form" method="post" action="{{url('/admin/post-generate-quotation-request')}}" role="form" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="row">
              <div class="form-group col-sm-12">
                <input type="text" placeholder="client Name" class="form-control" id="name" name="name"  value="{{ $data['company_name'] }}" placeholder="Name" >
              </div>
              <div class="form-group col-sm-12">
                <?php
