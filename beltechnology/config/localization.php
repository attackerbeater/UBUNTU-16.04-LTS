...
return [
    ...
    'locales' => [
        'en' => ['domain'=> 'http://localhost:8080/beltechnology/klanten', 'name' => 'English', 'script' => 'Latn', 'native' => 'English', 'regional' => 'en_GB'],
        'de' => ['domain'=> 'http://localhost:8080/beltechnology/klanten', 'name' => 'German', 'script' => 'Latn', 'native' => 'Deutsch', 'regional' => 'de_DE'],
    ],
