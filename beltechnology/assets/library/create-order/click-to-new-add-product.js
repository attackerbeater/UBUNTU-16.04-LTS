$(function() {
  // new order
  var max_fields = 9999;
  var _products = $(".order_product_new_append").find(".order_product_new_update")
  var x = 0;
  $('body').on("click", ".add_new_field_products", function(e) {
    e.preventDefault();
    if (x < max_fields) {   
      x++;
      counter = x;          
      _products.append('<div class="add-row" style="border-bottom:1px solid #eee; margin-bottom:5px;">' +
    ...
    if($(".add_new_field_products").hasClass('remove')){
