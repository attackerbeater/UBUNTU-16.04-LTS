$(function() {
    ...
    var add_button = $(".add_field_products_with-no-price");
    var x = 0;
    $('body').on("click", ".add_field_products_with-no-price", function(e) { 
        e.preventDefault();
        ...
        if($(".add_field_products_with-no-price ").hasClass('remove')){
